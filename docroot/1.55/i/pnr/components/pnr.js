{
    ...
    items: {
        ...
        cm: new Ext.grid.ColumnModel([{
            ...
            renderer: function(c, b, a) {
                if (a.get("cruisePackage")) {
                    return '<font color="#cc0000"><p  style="font-weight:bold;"> P-' + c + " </p></font>"
                }
            }
        }, {
            header: "Supplier",
            ...
            fixed: true,
            renderer: function(c, b, a) {
                if (a.get("cruisePackage") && a.get("type") != TDS.data.componentType.TYPE_CRUISE) {//adjustmentDiscount
                    return '<b><font color="#cc0000">P</font></b>'
                } else {
                	console.log(a.get("adjustmentDiscount"));
                	console.log(a.get("pricingPriceCurrency"));
                    return '<b><font color="black">' + TDS.util.Price.formatPrice((c- a.get("adjustmentDiscount")), a.get("pricingPriceCurrency") ) + "</font></b>"
                }
            }
        }]),
        viewConfig: {
        ...
        listeners: {
            ...
            rowclick: function(a, d, b) {
                if (a.lastExpandedRowIdx != null) {
                    var c = this.getView().getRow(a.lastExpandedRowIdx);
                    a.setHeightForRow()
                }
            }
        },
