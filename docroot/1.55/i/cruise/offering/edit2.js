																						...
																						items : [
																							{
																								...
																								items : [{
																									...
																									//	style : 'padding-left:220px;padding-top:50px;',
																										...
																										//items : [{
																										//		xtype : 'panel',width:300,height:200,
																													items:[
																													{
																												xtype : 'grid',id:'componentsGrid',
																											...
																											//	autoHeight : true,
																												...
																												store : new Ext.data.JsonStore({
																													url : "",
																													identifier : "",
																													fields : ["component" ,"cardIndex","componentName"],
																													data : [
																														{
																															 
																																'componentName':'Cruise',
																																'cardIndex':4,
																																	'component':'cruise'
																														}, 
																															{
																									...
																									//------------------------
																									{
																										...
																										/*	{
																												...
																												store : new Ext.data.JsonStore({
																													url : "",
																													identifier : "",
																													fields : ["locationToString", "name", "inDate", "outDate", "roomType", "dataURI", 'accommodationRatingURI']
																												}),
																												viewConfig : {
																													forceFit : true
																												},
																										...
																										items : [{
																												...
																												store : new Ext.data.JsonStore({
																													url : "",
																													identifier : "",
																												//	fields : ["gross", "comm", "nett", "status","transfers","transfers" ],
																												}),
																												viewConfig : {
																													forceFit : true
																												},
																										...
																										items : [{
																												...
																												scope : this,
																												handler : function (me) {
																												var gridSelection = 	Ext.getCmp('componentsGrid').getSelectionModel().getSelections()[0].data

																													TDS.workArea.config.card = gridSelection.cardIndex;
																													TDS.workArea.config.option = gridSelection.component;
																												//	sessionStorage.cruiseCode = Ext.getCmp('cruiseNumber').getValue();
																												//	var aa = TDS.session.findByPathSessionKey('inventory/accommodation', 'cruiseCode');
																												//	console.log(aa.data.value);
																												//	aa.data.value = Ext.getCmp('cruiseNumber').getValue();
																														
																														TDS.workArea.openTab('Inventory', 'inventory-administration1.js', '', TDS.env.sessionPath + 'inventory');

																													me.findParentByType('window').hide();
																													Ext.getCmp('cruiseNumber').findParentByType('awesomewindow').hide();
																												}
																											}, {
																												width : 20,
																												border : false
